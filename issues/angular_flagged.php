...
<html>
   <head>
     <?php
      echo "<title>Angular - {$_SESSION["Fname"]} {$_SESSION["Lname"]}</title>";
     ?>
      ...
      <nav class="top-bar" data-topbar role="navigation">
       ...
       <div class="row">
        <div class="large-12 columns">
          <div class="panel">
            <?php
              echo "<h1>Angular - {$_SESSION["Fname"]}"." ". "{$_SESSION["Lname"]}</h1>";
            ?>
          </div>
        </div>
      </div>
