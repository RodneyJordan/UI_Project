...
<html>
   <head>
     <?php
      echo "<title>Perl Dancer - {$_SESSION["Fname"]} {$_SESSION["Lname"]}</title>";
     ?>
      ...
      <nav class="top-bar" data-topbar role="navigation">
       ...
       <div class="row">
        <div class="large-12 columns">
          <div class="panel">
            <?php
              echo "<h1>Perl Dancer - {$_SESSION["Fname"]}"." ". "{$_SESSION["Lname"]}</h1>";
            ?>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="large-12 columns">
          <div class="icon-bar four-up">
            ...
            <a class="item" href="dancer.php">
              <img src="../img/svgs/fi-refresh.svg" >
              <label>All Perl Dancer</label>
            </a>
            <a class="item" href="https://github.com/PerlDancer/Dancer">
              <img src="../img/svgs/fi-social-github.svg" >
              <label>Git Repo</label>
            </a>

            <a class="item" href="http://perldancer.org">
              <img src="../img/svgs/fi-link.svg" >
              <label>Dancer Homepage</label>
            </a>
          </div>
        </div>
      </div>
