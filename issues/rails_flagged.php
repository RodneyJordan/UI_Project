...
<html>
   <head>
     <?php
      echo "<title>Ruby on Rails - {$_SESSION["Fname"]} {$_SESSION["Lname"]}</title>";
     ?>
      ...
      <nav class="top-bar" data-topbar role="navigation">
       ...
       <div class="row">
        <div class="large-12 columns">
          <div class="panel">
            <?php
              echo "<h1>Ruby on Rails - {$_SESSION["Fname"]}"." ". "{$_SESSION["Lname"]}</h1>";
            ?>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="large-12 columns">
          <div class="icon-bar four-up">
            ...
            <a class="item" href="rails.php">
              <img src="../img/svgs/fi-refresh.svg" >
              <label>All Ruby on Rails</label>
            </a>
