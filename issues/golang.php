    ...
    <body>
      ...
      <div class="row">
        <div class="large-12 columns">
          <div class="icon-bar four-up">
            ...
            <a class="item" href="golang_flagged.php">
      ...
      <div class="row">
        ...
        <div id="issues" class="large-9 columns">
          ...
          <div class="row issue">
            <div class="large-2 columns small-3"><img class="th avatar-thumbnail" src="<%= user.avatar_url %>" href="<%= user.html_url %>"></div>
            ...
            <img class="th avatar-thumbnail" src="<%= user.avatar_url %>"> says: <h4 id="modalTitle"><%= title %></h4>
               ...
               <form action="flag.php" method="post">
                 ...
                 <input type="hidden" name="page" value="golang.php">
